...
import { ScrollView, StyleSheet, View, Pressable, SafeAreaView } from 'react-native';
...
export default function OrderConfirmationScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor }]}>
      ...
      >
        <Animated.View entering={FadeIn.duration(500)} style={styles.animatedContainer}>
          ...
          <ThemedText style={{ textAlign: 'center', opacity: 0.7, marginTop: 8, fontSize: 16 }}>
            Your order has been confirmed
          </ThemedText>
          
          <ThemedView style={[styles.orderCard, { backgroundColor: cardBg, borderColor }]}>
            <View style={styles.orderHeader}>
              <ThemedText style={{ fontWeight: '700', fontSize: 18 }}>
                Order #{orderId}
              </ThemedText>
              <ThemedText style={{ fontWeight: '700', fontSize: 20, color: accentColor }}>
                ${total}
              </ThemedText>
            </View>
          ...
          <ThemedText style={{ textAlign: 'center', opacity: 0.6, marginTop: 24, fontSize: 14 }}>
          ...
          <Pressable 
            ...
            style={{ marginTop: 32 }}
          >
            <View style={[styles.continueButton, { backgroundColor: accentColor }]}>
